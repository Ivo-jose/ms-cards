package br.com.ivogoncalves.ms_cards.domain.exceptions.handler;
...
import br.com.ivogoncalves.ms_cards.domain.exceptions.DataIntegrityViolationException;
import br.com.ivogoncalves.ms_cards.domain.exceptions.ExceptionResponse;
...
public class CustomizedExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(ObjectNotNull.class)
	public ResponseEntity<ExceptionResponse> handleObjectNotNullException(Exception ex, WebRequest request) {
		ExceptionResponse exception = new ExceptionResponse(new Date(), ex.getMessage(), request.getDescription(true));
		return new ResponseEntity<ExceptionResponse>(exception,HttpStatus.BAD_REQUEST);
	}
}
